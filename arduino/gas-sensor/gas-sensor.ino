...
//**********************************************************
const uint8_t devAddr[4] = { 0x26, 0x01, 0x11, 0x28 };
const uint8_t appSKey[16] = { 0x24, 0x83, 0xC0, 0xDC, 0xD5, 0x2C, 0xD2, 0x73, 0x75, 0x56, 0x83, 0x46, 0xED, 0x25, 0x59, 0xDD };
const uint8_t nwkSKey[16] = { 0x89, 0x67, 0x31, 0xCB, 0x82, 0xD7, 0x21, 0xC5, 0x75, 0xE7, 0xB4, 0x4A, 0x8E, 0xC1, 0xEE, 0x3C };

//**********************************************************
// TODO: De poort waarop de data wordt verzonden
//       Andere poort per type sensor
//**********************************************************
const int LORAWAN_PORT = 30;
...
void getSensorValue()
{
    float volume = analogRead(A0)/1024.0;
    SerialUSB.print("The gas density is ");
    SerialUSB.println(volume);

    buffer[0] = ((int) (volume*1000) >> 8) & 0xFF;
    buffer[1] = ((int) (volume*1000) >> 0) & 0xFF;
    numberOfDataBytes = 2;
}
